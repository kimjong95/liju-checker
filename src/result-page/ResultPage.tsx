    ...
    <div className="page-layout">
      <div className="result-layout">
        ...
        <div className="result-content">
          ...
          <p>
            - 성취보다는 부드러운 삶: 계미일주는 희생정신을 가지고 있고, 소박한
            행복 철학을 추구합니다. 돈이나 건강에 구애받지 않고, 부드럽고 소박한
            삶을 살아갑니다.
          </p>
          {/* <p>
        ...
        <p>
          ...
          <p>
            ...
            고통을 겪을 수 있습니다. 대인관계는 원만하지만 자신을 극복해야 하는
            상황이 많습니다.
          </p>
          <p>
          ...
          <p>
            ...
            배우자에 대한 영향을 받기 쉽습니다. 직장과 재물 측면에서 약함을 느낄
            수도 있으며, 배우자와의 관계에서 어려움을 겪을 수도 있습니다.
          </p>
          <p>
            이러한 특징을 고려하여, 계미일주와의 연애와 결혼 관계에서는 조화롭고
            원만한 대인관계를 유지하고, 결과보다는 과정과 성장을 중요시하며,
            건강과 자기 신념에 관심을 기울이는 점을 고려해야 합니다. 또한 야망과
            주의가 필요하며, 사업 인연에 주의하고, 직장과 재물, 배우자에 대한
            관계에서 조심하는 것이 좋습니다.
          </p>
        </div>
        <button className="card-button-link" onClick={() => alert("링크복사")}>
          결과 공유
        </button>
